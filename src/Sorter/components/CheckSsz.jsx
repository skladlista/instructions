        ...
        <ol>
          ...
          <li className="article__subtitle">
            <details>
              ...
              <ol className="article__list sublist">
                <li>
                  Для нахождения листов из EWM в Excel, надо скопировать колонку
                  <span className="bold"> Единица обработки (ЕО)</span> из EWM и
                  вставить в черновик в Excel. И с помощью{" "}
                  <span className="bold">ДОПОЛНИТЕЛЬНОГО ФИЛЬТРА</span> найти
                  данные листы в таблице СКЛАД ЛИСТА и скопировать их в
                  черновик, чтобы можно было проверить их.
                </li>
                <li>
                  Проверить параметры найденных листов (ширина, толщина, марка
